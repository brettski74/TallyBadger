...
5. As per the definition of done, **all** tests must be run before implementation can be considered done.
5. When implementation is done, provide a **completion narrative**: what changed, any **architecture** impact (see **ARCH.md**), caveats, and which tests or docs moved. Wait for the user to review your completion narrative before proceeding beyond this point in the workflow.
