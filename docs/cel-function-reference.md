...
**Related:** [Import rules engine](import-rules-engine.md) ([#8](https://github.com/brettski74/TallyBadger/issues/8), [#94](https://github.com/brettski74/TallyBadger/issues/94)) — CEL rule model, `attributes` / `match` activation map, capture gating, CSV and API surfaces.
